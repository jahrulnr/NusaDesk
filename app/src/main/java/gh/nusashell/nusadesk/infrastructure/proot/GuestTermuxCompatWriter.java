...
public final class GuestTermuxCompatWriter {
    ...
    public static String moduleContent(String appVersion) {
        ...
        return String.join("\n",
                ...
                "# The host refuses to encode a frame beyond 64 KiB",
                "# (AndroidCapabilityProtocol.MAX_FRAME_BYTES); this cap matches",
                "# that bound, so a legal large read is never rejected here.",
