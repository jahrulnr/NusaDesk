...
- Do not request broad storage, LAN, battery-exemption, or foreground-service permissions without a concrete user-visible requirement and documentation.
